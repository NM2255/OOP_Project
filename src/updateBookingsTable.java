...
public class updateBookingsTable {
    updateBookingsTable(){}

    public JTable getBookings() throws SQLException {
        String[][] data = {};
        String[] columnNames = { "ID","Destination", "Departure", "Departure Date", "Return Date","First Name",
                "Last Name","NIC","Phone #","Address","Bus Name","Bus Number" };
        ...
        String in = "select * from reservation";
